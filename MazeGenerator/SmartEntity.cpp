...
SmartEntity::SmartEntity() : MovingEntity() {}
SmartEntity::SmartEntity(EntityProperties* properties, std::string textureFileName) : MovingEntity(properties, textureFileName) {
	this->self = std::make_shared<SmartEntity>(*this);
}

EntityState SmartEntity::getDefaultState() {
	EntityState state;
